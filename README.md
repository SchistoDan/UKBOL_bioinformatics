...
1. The sample_metadata sheet in the specimen sampling [`UK*_processing.xlsx`](https://naturalhistorymuseum.sharepoint.com/:f:/r/sites/UKBarcodeofLife/Shared%20Documents/UKBOL_accelerated/UKBOL_Collection/batches?csf=1&web=1&e=ciVFcy) will be automatically populated from the 'Processing' sheet. 
